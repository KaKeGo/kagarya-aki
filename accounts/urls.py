...
from .views import (
    ...
    ChangePasswordAPIView, PasswordResetAPIView, PasswordResetConfirmAPIView,
)
...
urlpatterns = [
    ...
    path('reset-password-confirm/<str:token>/', PasswordResetConfirmAPIView.as_view(), name='reset_password_confirm'),
